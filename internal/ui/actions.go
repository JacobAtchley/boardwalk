...
// can drive both outcomes without depending on which clipboard and browser
// commands the machine running the suite has — and without really opening a
// browser window while it runs.
var (
...
// report pairs what an action did with what to say when it did not. Copying
// and opening are separate processes that can be missing or refuse, and both
// calls return an error: without this the status line said "copied id 4021" on
// a machine where nothing had been copied at all.
